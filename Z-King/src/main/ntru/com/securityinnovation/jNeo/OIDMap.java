 ...
 *
 * <p>
 * The problem this class is trying to solve is to provide access
 * to the OID.getOIDBytes() throughout the jNeo package and
 * sub-packages, while denying applications access to this
 * same data.
 *
 * <p>
 * Making OID.getOIDBytes() public generally is bad because
 ...
 *
 * <p>
 * Making OID.getOIDBytes() public and then hiding it from the
 ...
 *
 * <p>
 * The solution arrived at is to make the method package-public,
