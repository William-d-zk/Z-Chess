...
public class KeyParams
{
    ...
    {
        if(numParamSets == 0) {initParamSets();}
        for(int i = 0; i < numParamSets; i++) {if(paramSet == paramSets[i].OIDEnum) {return paramSets[i];}}
        throw new ParamSetNotSupportedException(paramSet);
    }
    ...
    private static void initParamSets()
    {
        ...
        paramSets[numParamSets++] = new KeyParams(OID.ees401ep1, 401, 3, 2048,    // id, N, p, q
                                                  ...
                                                  112);                           // pkLen
        paramSets[numParamSets++] = new KeyParams(OID.ees449ep1, 449, 3, 2048,    // id, N, p, q
                                                  ...
                                                  128);                           // pkLen
        paramSets[numParamSets++] = new KeyParams(OID.ees677ep1, 677, 3, 2048,    // id, N, p, q
                                                  ...
                                                  192);                           // pkLen
        paramSets[numParamSets++] = new KeyParams(OID.ees1087ep2, 1087, 3, 2048,  // id, N, p, q
                                                  ...
                                                  256);                           // pkLen
        paramSets[numParamSets++] = new KeyParams(OID.ees541ep1, 541, 3, 2048,    // id, N, p, q
                                                  ...
                                                  112);                           // pkLen
        paramSets[numParamSets++] = new KeyParams(OID.ees613ep1, 613, 3, 2048,    // id, N, p, q
                                                  ...
                                                  128);                           // pkLen
        paramSets[numParamSets++] = new KeyParams(OID.ees887ep1, 887, 3, 2048,    // id, N, p, q
                                                  ...
                                                  192);                           // pkLen
        paramSets[numParamSets++] = new KeyParams(OID.ees1171ep1, 1171, 3, 2048,  // id, N, p, q
                                                  ...
                                                  256);                           // pkLen
        paramSets[numParamSets++] = new KeyParams(OID.ees659ep1, 659, 3, 2048,    // id, N, p, q
                                                  ...
                                                  112);                           // pkLen
        paramSets[numParamSets++] = new KeyParams(OID.ees761ep1, 761, 3, 2048,    // id, N, p, q
                                                  ...
                                                  128);                           // pkLen
        paramSets[numParamSets++] = new KeyParams(OID.ees1087ep1, 1087, 3, 2048,  // id, N, p, q
                                                  ...
                                                  192);                           // pkLen
        paramSets[numParamSets++] = new KeyParams(OID.ees1499ep1, 1499, 3, 2048,  // id, N, p, q
