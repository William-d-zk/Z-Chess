...
public class KeyParams
{
    ...
    private static void initParamSets()
    {
        ...
        paramSets[numParamSets++] = new KeyParams(OID.ees401ep1,
                                                  ...
                                                  60,                             // maxMsgLenBytes,
                                                  600,
                                                  400,                       // bufferLenBits, bufferLenTrits
                                                  113,                            // dm0
                                                  sha1,
        ...
        paramSets[numParamSets++] = new KeyParams(OID.ees449ep1,
                                                  ...
                                                  67,                             // maxMsgLenBytes,
                                                  672,
                                                  448,                       // bufferLenBits, bufferLenTrits
                                                  134,                            // dm0
                                                  sha1,
                                                  sha1,                     // mgfHash, igfHash
                                                  134,
        ...
        paramSets[numParamSets++] = new KeyParams(OID.ees677ep1,
                                                  ...
                                                  101,                            // maxMsgLenBytes,
                                                  1008,
                                                  676,                      // bufferLenBits, bufferLenTrits
                                                  157,                            // dm0
                                                  sha256,
        ...
        paramSets[numParamSets++] = new KeyParams(OID.ees1087ep2,
                                                  ...
                                                  170,                            // maxMsgLenBytes,
                                                  1624,
                                                  1086,                     // bufferLenBits, bufferLenTrits
                                                  120,                            // dm0
                                                  sha256,
                                                  sha256,                 // mgfHash, igfHash
                                                  120,
                                                  13,
                                                  25,
                                                  14,                // dr, c, minCallsR, minCallsMask
                                                  256);                           // pkLen
        paramSets[numParamSets++] = new KeyParams(OID.ees541ep1,
                                                  ...
                                                  86,                             // maxMsgLenBytes,
                                                  808,
                                                  540,                       // bufferLenBits, bufferLenTrits
                                                  49,                             // dm0
                                                  sha1,
                                                  sha1,                     // mgfHash, igfHash
                                                  49,
                                                  12,
                                                  15,
                                                  11,                 // dr, c, minCallsR, minCallsMask
                                                  112);                           // pkLen
        paramSets[numParamSets++] = new KeyParams(OID.ees613ep1,
                                                  ...
                                                  97,                             // maxMsgLenBytes,
                                                  912,
                                                  612,                       // bufferLenBits, bufferLenTrits
                                                  55,                             // dm0
                                                  sha1,
                                                  sha1,                     // mgfHash, igfHash
                                                  55,
                                                  11,
                                                  16,
                                                  13,                 // dr, c, minCallsR, minCallsMask
                                                  128);                           // pkLen
        paramSets[numParamSets++] = new KeyParams(OID.ees887ep1,
                                                  ...
                                                  141,                            // maxMsgLenBytes,
                                                  1328,
                                                  886,                      // bufferLenBits, bufferLenTrits
                                                  81,                             // dm0
                                                  sha256,
                                                  sha256,                 // mgfHash, igfHash
                                                  81,
                                                  10,
                                                  13,
                                                  12,                 // dr, c, minCallsR, minCallsMask
                                                  192);                           // pkLen
        paramSets[numParamSets++] = new KeyParams(OID.ees1171ep1,
                                                  ...
                                                  186,                            // maxMsgLenBytes,
                                                  1752,
                                                  1170,                     // bufferLenBits, bufferLenTrits
                                                  106,                            // dm0
                                                  sha256,
                                                  sha256,                 // mgfHash, igfHash
                                                  106,
                                                  12,
                                                  20,
                                                  15,                // dr, c, minCallsR, minCallsMask
                                                  256);                           // pkLen
        paramSets[numParamSets++] = new KeyParams(OID.ees659ep1,
                                                  ...
                                                  108,                            // maxMsgLenBytes,
                                                  984,
                                                  658,                       // bufferLenBits, bufferLenTrits
                                                  38,                             // dm0
                                                  sha1,
                                                  sha1,                     // mgfHash, igfHash
                                                  38,
        ...
        paramSets[numParamSets++] = new KeyParams(OID.ees761ep1,
                                                  ...
                                                  125,                            // maxMsgLenBytes,
                                                  1136,
                                                  760,                      // bufferLenBits, bufferLenTrits
                                                  42,                             // dm0
                                                  sha1,
                                                  sha1,                     // mgfHash, igfHash
                                                  42,
                                                  12,
                                                  13,
                                                  16,                 // dr, c, minCallsR, minCallsMask
                                                  128);                           // pkLen
