 ...
 * 良仓订单实体
 *
 * @author xiaojiang.lxj at 2024-09-24 09:59.
 */
@Entity(name = "zc_ex_form_lc_order_list")
@Table(indexes = {
    @Index(name = "zc_ex_form_lc_order_list_pkey", columnList = "id",
        unique = true) })
@JsonNaming(SnakeCaseStrategy.class)
@ISerialGenerator(parent = ISerial.STORAGE_ROOK_DB_SERIAL)
public class LcOrderEntity extends AuditModel{


    @Serial
    private static final long serialVersionUID = 2594310548247721737L;
    ...
    public void setOrder_pack_box(
        List<OrderPackBox> order_pack_box) {
