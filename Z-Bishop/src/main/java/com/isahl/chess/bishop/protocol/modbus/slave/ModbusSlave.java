...
public class ModbusSlave {
    ...
    public void registerHandler(ModbusFunction function, FunctionHandler handler) {
        ...
        LOG.info("Registered handler for function: {} (0x{:02X})", function.getDescription(), function.getCode());
    }
    ...
    private void handleClient(AsynchronousSocketChannel clientChannel) {
        try {
            ...
            int bytesRead = clientChannel.read(java.nio.ByteBuffer.wrap(buffer.array(), 0, 256))
            ...
            if (bytesRead > 0) {
                ...
                if (response != null) {
                    ...
                    clientChannel.write(java.nio.ByteBuffer.wrap(responseData))
                        .get(config.getTimeoutMs(), TimeUnit.MILLISECONDS);
                }
            }
        } catch (Exception e) {
    ...
    private ModbusResponse processRequest(ByteBuf buffer) {
        try {
            ...
            return ModbusResponse.exception(0, ModbusFunction.READ_HOLDING_REGISTERS, 
