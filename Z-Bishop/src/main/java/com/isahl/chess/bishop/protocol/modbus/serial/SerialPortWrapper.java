...
class JSerialPortWrapper implements SerialPortWrapper {
    ...
    public boolean open() throws IOException {
        try {
            ...
            java.lang.reflect.Method setFlowControl = serialPortClass.getMethod("setFlowControl", int.class);
            ...
            throw new IOException("jSerialComm library not found. Add dependency: com.fazecast:jSerialComm:[2.0,3.0.0)", e);
        } catch (Exception e) {
