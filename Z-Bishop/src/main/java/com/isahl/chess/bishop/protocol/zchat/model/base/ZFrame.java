...
public class ZFrame extends ZProtocol implements IFrame, IDuplicate {
  public static final byte frame_op_code_transaction = 0x20;
  public static final byte frame_op_code_duplicate = 0x10;
  public static final byte frame_op_code_qos_1 = 0x04;
  public static final byte frame_op_code_qos_2 = 0x08;
  public static final byte frame_op_code_qos_3 = 0x0C;
  public static final byte frame_op_code_qos_mask = 0x0C;
  public static final byte frame_op_code_qos_bit_left = 2;
  public static final byte frame_op_code_sequence_1 = 0x01;
  public static final byte frame_op_code_sequence_2 = 0x02;
  public static final byte frame_op_code_sequence_3 = 0x03;
  public static final byte frame_op_code_sequence_mask = 0x03;
  public static final byte frame_op_code_ctrl = 0x40;
  private static final int frame_op_code_fin_more = 0x80;

  public static final int frame_payload_length_7_no_transaction_position = 1;
  public static final int frame_payload_length_14_no_transaction_position = 2;
  public static final int frame_payload_length_21_no_transaction_position = 3;
  public static final int frame_payload_length_28_no_transaction_position = 4;
  public static final int frame_payload_length_7_transaction_position = 9;
  public static final int frame_payload_length_14_transaction_position = 10;
  public static final int frame_payload_length_21_transaction_position = 11;
  public static final int frame_payload_length_28_transaction_position = 12;
  ...
  public int length() {
    return 1
        + (isTransactional() ? 8 : 0)
        + ByteBuf.vSizeOf(mPayload == null ? 0 : mPayload.length);
  }
  ...
  public ZFrame withSub(IoSerial sub) {
    ...
    if (encoded != null && encoded.capacity() > 0) {
  ...
  public static int peekSubSerial(ByteBuf buffer) {
    return Objects.requireNonNull(buffer).peekUnsigned(1);
  }
}
