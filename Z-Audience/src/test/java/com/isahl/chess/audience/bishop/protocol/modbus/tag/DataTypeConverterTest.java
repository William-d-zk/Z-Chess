...
class DataTypeConverterTest {
    ...
    void testBooleanConversion() {
        ...
        assertEquals(true, DataTypeConverter.toJavaValue(registersTrue, DataType.BOOLEAN, ByteOrder.ABCD));
        assertEquals(false, DataTypeConverter.toJavaValue(registersFalse, DataType.BOOLEAN, ByteOrder.ABCD));
    }
}
