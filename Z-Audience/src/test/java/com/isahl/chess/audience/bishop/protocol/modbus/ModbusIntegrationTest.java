 ...
 * Modbus 集成测试
 *
 * <p>注意：此测试需要真实的 Modbus 从站设备或模拟器 运行前请确保启动 Modbus 从站模拟器在 localhost:502
 */
...
class ModbusIntegrationTest {
  ...
  void testMasterReadHoldingRegisters() throws Exception {
    ...
    ModbusResponse response = master.sendRequest(master.createReadHoldingRegisters(1, 0, 10));
